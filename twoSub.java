 ...
 * @author abdal
 */
public class twoSub extends javax.swing.JFrame {

    /**
     * Creates new form twoSub
     */
    public twoSub() {
        imageIcon();
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(twoSub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
